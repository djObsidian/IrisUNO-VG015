...
![Вид сверху](<images/IrisUNO_top_view.png>)  

## Статья на Habr
[Ещё одна отладочная плата и тесты К1921ВГ015](https://habr.com/ru/articles/957832/)
## Видео на Youtube
[Iris UNO-ВГ015 отладочная плата с отечественным микроконтроллером!](https://www.youtube.com/watch?v=FaNaOod3lDg)
...
![Перспективный вид](<images/IrisUNO_perspective.png>)  
\*-Производитель и ёмкость памяти может отличаться, но не менее 4 Мб. 

## Назначения пинов
### Распиновка МК

![Распиновка МК](<images/pinout.jpg>)  
...
## Errata
Известные проблемы описаны в файле ./errata.md
